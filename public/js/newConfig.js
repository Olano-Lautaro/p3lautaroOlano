function newConfig(){
    ...
    Hora de inicio: <input type="time" name="start_new" min="15:55:00" max="22:25:00"><br>
    Hora de Fin: <input type="time" name="finish_new" min="15:55:00" max="22:25:00"><br>
    Rango: <input type="time" name="stop_new"  min="15:55:00" max="22:25:00">
    <br>`;
